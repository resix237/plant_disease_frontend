  ...
  const Menus = [
    ...
    },
    {
      ...
      icon: <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M9.99988 1V4.99989C9.99988 5.2651 10.1052 5.51944 10.2928 5.70698C10.4803 5.89451 10.7346 5.99986 10.9999 5.99986H14.9997" stroke="#3B4C0E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        ...
        <path d="M12.7496 14.5C12.7496 14.8978 12.9077 15.2794 13.189 15.5607C13.4703 15.842 13.8518 16 14.2496 16C14.6475 16 15.029 15.842 15.3103 15.5607C15.5916 15.2794 15.7496 14.8978 15.7496 14.5C15.7496 14.1022 15.5916 13.7206 15.3103 13.4393C15.029 13.158 14.6475 13 14.2496 13C13.8518 13 13.4703 13.158 13.189 13.4393C12.9077 13.7206 12.7496 14.1022 12.7496 14.5Z" stroke="#3B4C0E" stroke-width="0.8" stroke-linecap="round" stroke-linejoin="round" />
      </svg>,
      iconLight: <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M9.99988 1V4.99989C9.99988 5.2651 10.1052 5.51944 10.2928 5.70698C10.4803 5.89451 10.7346 5.99986 10.9999 5.99986H14.9997" stroke="#FFFFFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        ...
        <path d="M12.7496 14.5C12.7496 14.8978 12.9077 15.2794 13.189 15.5607C13.4703 15.842 13.8518 16 14.2496 16C14.6475 16 15.029 15.842 15.3103 15.5607C15.5916 15.2794 15.7496 14.8978 15.7496 14.5C15.7496 14.1022 15.5916 13.7206 15.3103 13.4393C15.029 13.158 14.6475 13 14.2496 13C13.8518 13 13.4703 13.158 13.189 13.4393C12.9077 13.7206 12.7496 14.1022 12.7496 14.5Z" stroke="#FFFFFF" stroke-width="0.8" stroke-linecap="round" stroke-linejoin="round" />
      </svg>,
      path: "/documentation"
    },
  ];
...
/> */}
  ...
  /> */}
        ...
        <div hidden={NavOpen} className="lg:flex-1 w-full h-screen overflow-y-auto bg-anti-white">
          ...
          <div className=" py-5 md:px-10 px-5 w-full">
            {children}
          </div>
